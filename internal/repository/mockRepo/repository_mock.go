...
//
//	mockgen -source repo.go -destination mockRepo/repository_mock.go -package repository
//
...
func (m *MockRepoInterface) SaveUser(userData models.NewUser, hashedPass []byte) (models.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveUser", userData, hashedPass)
	ret0, _ := ret[0].(models.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepoInterfaceMockRecorder) SaveUser(userData, hashedPass any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveUser", reflect.TypeOf((*MockRepoInterface)(nil).SaveUser), userData, hashedPass)
}
