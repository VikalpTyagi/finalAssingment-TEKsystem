	...
	tests := []struct {
		...
		},
		{
			...
			setup: func() (*gin.Context, *httptest.ResponseRecorder, services.Service) {
				...
				ms.EXPECT().CreateUser(ctx, gomock.Any()).Return(models.User{}, errors.New("test error")).Times(1)
				return c, rr, ms
			},
			expectedStatusCode: 400,
		...
		},
		{
			...
			ExpectedResponse:   `{"ID":0,"CreatedAt":"0001-01-01T00:00:00Z","UpdatedAt":"0001-01-01T00:00:00Z","DeletedAt":null,"name":"Vikalp Tyagi","email":"vikalp@gmail.com"}`,
		},
	}
